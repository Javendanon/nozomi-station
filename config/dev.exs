...
config :nozomi_station, NozomiStationWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "OO4wpNR0C/yCGO/y2LC+Qk61Qkh4wcZGnpunymCykzUxC07FSq+7/OAGUA2oBZOC",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:nozomi_station, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:nozomi_station, ~w(--watch)]}
  ]
...
config :nozomi_station, NozomiStationWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/nozomi_station_web/router\.ex$",
      ~r"lib/nozomi_station_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :nozomi_station, dev_routes: true
